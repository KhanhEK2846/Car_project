...
{
	MOTOR_STOP,
	MOTOR_CTRL_FORWARD, //dieu khien dong co thuan chieu
	MOTOR_CTRL_BACKWARD, //dieu khien dong co nguoc chieu
}MotorState;
/* USER CODE END PTD */
...
//speed: 0->100
//RPWM = 1 LPWM = 0 -> Motor quay thuan
//RPWM = 0 LPWM = 1 -> Motor quay nghich
//RPWM = 0 LPWM = 0 -> Motor dung
